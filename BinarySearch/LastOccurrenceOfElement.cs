...
{
    /*Given a sorted array containing duplicate elements, find the last occurrence of the target element.*/
    /*
    Time Complexity (TC):
    O(log n)
    ...
    in the right half to check if the target occurs later.
...
*/
    public class LastOccurrenceOfElement
    {
        ...
        public static void Main(string[] args)
        {
            ...
            int result = FindLast(numbers, target);

namespace DataStructure.Sorting
{
    ...
    */
    public class MergeKSortedArrays
    {
        ...
        Array 1 = [2, 6, 12, 34]
        Array 2 = [1, 9, 20, 1000]
        Array 3 = [23, 34, 90, 2000]
        Array 4 = [50, 60, 80, 500]
        Array 5 = [10, 20, 30, 40]

        Step 1: Merge Array 1 and Array 2

        [2, 6, 12, 34]
        [1, 9, 20, 1000]

        Merged Result:
        [1, 2, 6, 9, 12, 20, 34, 1000]

        --------------------------------------------------

        Step 2: Merge Previous Result with Array 3
        ...
        Step 3: Merge Previous Result with Array 4

        [1, 2, 6, 9, 12, 20, 23, 34, 34, 90, 1000, 2000]
        [50, 60, 80, 500]

        Merged Result:
        [1, 2, 6, 9, 12, 20, 23, 34, 34, 50, 60, 80, 90, 500, 1000, 2000]

        --------------------------------------------------

        Step 4: Merge Previous Result with Array 5

        [1, 2, 6, 9, 12, 20, 23, 34, 34, 50, 60, 80, 90, 500, 1000, 2000]
        [10, 20, 30, 40]

        Merged Result:
        [1, 2, 6, 9, 10, 12, 20, 20, 23, 30, 34, 34, 40, 50, 60, 80, 90, 500, 1000, 2000]
